...
export const HeadIndexArt = () => {
  <Head>
    ...
    <meta
      name="description"
      content="Multidisciplinär konstnär som rör sig mellan teckning och språket, det digitala, rörliga och stillbilder."
    />
    ...
    <meta
      property="og:image"
      content="/art/vi-kan-battre-tova-jertfelt-kandidatexamen-2016-konstfack.png"
    />
...
export const HeadIndexDesign = () => {
  <Head>
    ...
    <meta
      name="description"
      content="Multidisciplinär formgivare med erfarenhet av digital kommunikation. Tillgänglig för frilans! "
    />
    <meta name="author" content="Tova Jertfelt"></meta>
    ...
    <meta
      property="twitter:image"
      content="/design/kollektiv-sorg-samples.png"
    />
...
export const HeadIndexIllustraion = () => {
  return (
    <Head>
      ...
      <meta
        name="description"
        content="Multidisciplinär illustratör som jobbar både digitalt och analogt. Tillgänglig för frilans! "
      />
      <meta name="author" content="Tova Jertfelt"></meta>
      ...
      <meta
        property="og:url"
        content="https://www.tovajertfelt.se/illustration"
      />
      ...
      <meta
        property="og:image"
        content="/illustraion/fire-color-jertfelt.png"
      />
...
export const HeadIndexFrontend = () => {
  return (
    <Head>
      ...
      <meta
        name="description"
        content="Multidisciplinär frontendare med bakgrund inom visuell kommunikation, digital produktion och frilans söker jobb! "
      />
      <meta name="author" content="Tova Jertfelt"></meta>
      ...
      <meta
        property="twitter:url"
        content="https://www.tovajertfelt.se/frontend"
      />
...
const HeadIndex = () => {
  return (
    <Head>
      ...
      <meta
        property="og:image"
        content="https://tovajertfelt.netlify.app/publishing-priset-2.png"
      />

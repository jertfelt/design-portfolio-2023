...
const Body = () => {
  ...
  return (
    <Section>
      <Content>
        <p>{t("artistpages.main.first")}</p>
        <p>{t("artistpages.main.second")}</p>
        <p>
          {t("artistpages.main.third")}
          <Link href="https://www.omkonst.com/16-konstfackskolan-varsutstallning.shtml">
            {" "}
            &quot;{t("artistpages.main.linkOmKonst")}&quot;
          </Link>
          {t("artistpages.main.thirdpart2")}
        </p>
      ...
      <WrapperExhibitions>
        ...
        <div className="publ">
          ...
          <div>
            <h3 className="pub">Not Like a Bedbug</h3>
            <h4 className="desc">{t("artistpages.main.h4MAL")}</h4>
          </div>
        </div>
      </WrapperExhibitions>
